...
namespace Clinical_Trials_Adverse_Events_Reporting_System.Migrations
{
    ...
    [Migration("20220503150553_migration11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinical_Trials_Adverse_Events_Reporting_System.Entities.AdverseEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Clinical_Trials_Adverse_Events_Reporting_System.Entities.CountryRequirementVersion", b =>
                {
                    ...
                    b.ToTable("CountryRequirementVersion");
                });
            ...
            modelBuilder.Entity("Clinical_Trials_Adverse_Events_Reporting_System.Entities.InvestigationalProductType", b =>
                {
                    ...
                    b.ToTable("InvestigationalProductType");
                });
            ...
            modelBuilder.Entity("Clinical_Trials_Adverse_Events_Reporting_System.Entities.NationalRequirement", b =>
                {
                    ...
                    b.ToTable("NationalRequirement");
                });

            modelBuilder.Entity("Clinical_Trials_Adverse_Events_Reporting_System.Entities.NationalRequirementVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NationalRequirementVersion");
                });
            ...
            modelBuilder.Entity("Clinical_Trials_Adverse_Events_Reporting_System.Entities.ReportedInstitution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AdverseEventId");

                    b.HasIndex("InstitutionId");

                    b.ToTable("ReportedInstitution");
                });
            ...
            modelBuilder.Entity("Clinical_Trials_Adverse_Events_Reporting_System.Entities.ReportedInstitution", b =>
                {
                    b.HasOne("Clinical_Trials_Adverse_Events_Reporting_System.Entities.AdverseEvent", "AdverseEvent")
                        .WithMany()
                        .HasForeignKey("AdverseEventId");

                    b.HasOne("Clinical_Trials_Adverse_Events_Reporting_System.Entities.Institution", "Institution")
                        .WithMany()
                        .HasForeignKey("InstitutionId");

                    b.Navigation("AdverseEvent");
